        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building intelligent applications using Python, Django, and
                modern AI/ML frameworks. From NLP-powered education tools to
                full-stack healthcare systems with REST APIs.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Hardware & Cloud Deployments</h4>
              <p>
                Designing embedded systems for real-world safety and IoT
                solutions using ESP32, GPS/GSM modules. Experienced with Git,
                GitHub workflows, and cloud deployments on Render & Hugging Face.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">ESP32</div>
                <div className="what-tags">Arduino</div>
                <div className="what-tags">GSM / GPS</div>
